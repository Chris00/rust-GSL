...
pub mod legendre {
    pub mod complete {
        ...
        pub fn ellint_Kcomp(k: f64, mode: Prec) -> f64 {
        ...
        pub fn ellint_Kcomp_e(k: f64, mode: Prec) -> Result<types::Result, Error> {
        ...
        pub fn ellint_Ecomp(k: f64, mode: Prec) -> f64 {
        ...
        pub fn ellint_Ecomp_e(k: f64, mode: Prec) -> Result<types::Result, Error> {
            let mut result = MaybeUninit::<sys::gsl_sf_result>::uninit();
        ...
        pub fn ellint_Pcomp(k: f64, n: f64, mode: Prec) -> f64 {
        ...
        pub fn ellint_Pcomp_e(k: f64, n: f64, mode: Prec) -> Result<types::Result, Error> {
            let mut result = MaybeUninit::<sys::gsl_sf_result>::uninit();
    ...
    pub mod incomplete {
        ...
        pub fn ellint_F(phi: f64, k: f64, mode: Prec) -> f64 {
        ...
        pub fn ellint_F_e(phi: f64, k: f64, mode: Prec) -> Result<types::Result, Error> {
            let mut result = MaybeUninit::<sys::gsl_sf_result>::uninit();
        ...
        pub fn ellint_E(phi: f64, k: f64, mode: Prec) -> f64 {
        ...
        pub fn ellint_E_e(phi: f64, k: f64, mode: Prec) -> Result<types::Result, Error> {
            let mut result = MaybeUninit::<sys::gsl_sf_result>::uninit();
        ...
        pub fn ellint_P(phi: f64, k: f64, n: f64, mode: Prec) -> f64 {
        ...
        pub fn ellint_P_e(phi: f64, k: f64, n: f64, mode: Prec) -> Result<types::Result, Error> {
            let mut result = MaybeUninit::<sys::gsl_sf_result>::uninit();
            let ret =
        ...
        pub fn ellint_D(phi: f64, k: f64, mode: Prec) -> f64 {
        ...
        pub fn ellint_D_e(phi: f64, k: f64, mode: Prec) -> Result<types::Result, Error> {
            let mut result = MaybeUninit::<sys::gsl_sf_result>::uninit();
...
pub mod carlson {
    ...
    pub fn ellint_RC(x: f64, y: f64, mode: Prec) -> f64 {
        unsafe { sys::gsl_sf_ellint_RC(x, y, mode.into()) }
    }

    /// This routine computes the incomplete elliptic integral RC(x,y) to the accuracy specified by the mode variable mode.
    #[doc(alias = "gsl_sf_ellint_RC_e")]
    pub fn ellint_RC_e(x: f64, y: f64, mode: Prec) -> Result<types::Result, Error> {
        let mut result = MaybeUninit::<sys::gsl_sf_result>::uninit();
    ...
    pub fn ellint_RD(x: f64, y: f64, z: f64, mode: Prec) -> f64 {
        unsafe { sys::gsl_sf_ellint_RD(x, y, z, mode.into()) }
    }

    /// This routine computes the incomplete elliptic integral RD(x,y,z) to the accuracy specified by the mode variable mode.
    #[doc(alias = "gsl_sf_ellint_RD_e")]
    pub fn ellint_RD_e(x: f64, y: f64, z: f64, mode: Prec) -> Result<types::Result, Error> {
        let mut result = MaybeUninit::<sys::gsl_sf_result>::uninit();
    ...
    pub fn ellint_RF(x: f64, y: f64, z: f64, mode: Prec) -> f64 {
        unsafe { sys::gsl_sf_ellint_RF(x, y, z, mode.into()) }
    }

    /// This routine computes the incomplete elliptic integral RF(x,y,z) to the accuracy specified by the mode variable mode.
    #[doc(alias = "gsl_sf_ellint_RF_e")]
    pub fn ellint_RF_e(x: f64, y: f64, z: f64, mode: Prec) -> Result<types::Result, Error> {
        let mut result = MaybeUninit::<sys::gsl_sf_result>::uninit();
    ...
    pub fn ellint_RJ(x: f64, y: f64, z: f64, p: f64, mode: Prec) -> f64 {
        unsafe { sys::gsl_sf_ellint_RJ(x, y, z, p, mode.into()) }
    }

    /// This routine computes the incomplete elliptic integral RJ(x,y,z,p) to the accuracy specified by the mode variable mode.
    #[doc(alias = "gsl_sf_ellint_RJ_e")]
    pub fn ellint_RJ_e(x: f64, y: f64, z: f64, p: f64, mode: Prec) -> Result<types::Result, Error> {
        let mut result = MaybeUninit::<sys::gsl_sf_result>::uninit();
